begin
  ...
  raise "The Vagrant  NFS plugin must be run within Vagrant."
end

if Vagrant::VERSION < "1.5.0"
  raise "The Vagrant  NFS plugin is only compatible with Vagrant 1.5.0+"
end
...
module VagrantPlugins
  module VagrantNfs
    class Plugin < Vagrant.plugin(2)
      ...
      description <<-DESC
      This plugin adds NFS support on Windows for Vagrant with the  NFS Server.
      DESC
      ...
      def self.init_plugin
        I18n.load_path << File.expand_path('locales/en.yml', VagrantNfs.source_root)
        I18n.reload!
      end
